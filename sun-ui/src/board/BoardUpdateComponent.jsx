...
const BoardUpdateComponent = () => {
    ...
    useEffect(() => {
        ...
        const fetchNoticeData = async () => {
            try {
                const response = await axios.get(`http://sun-api:8787/boardDetail/${notiCode}`);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post(`http://sun-api:8787/updateBoard/${notiCode}`, formData, {
                headers: {
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="form-group">
                    ...
                    <CKEditor
                        ...
                        config={{
                            ckfinder: {
                                uploadUrl: 'http://sun-api:8787/uploadImageBoard', // 이미지 업로드 서버 경로
                            },
                            toolbar: [
