...
const MyPageComponent = () => {
    ...
    useEffect(() => {
        if (employee && employee.empcode) {
            fetch(`http://sun-api:8787/memberDetail/${employee.empcode}`)
                .then(response => {
                    if (!response.ok) {
                ...
                .then(data => {
                    axios.get(`http://sun-api:8787/getMemberImage?empCode=${employee.empcode}`)
    ...
    useEffect(() => {
        if (employee && employee.empcode) {
            ...
            axios.get(`http://sun-api:8787/api/edoc/getEmpSignatures?empCodes=${employee.empcode}`)
                .then((res) => {
    ...
    const handleUpload = () => {
        ...
        fetch('http://sun-api:8787/uploadImage', {
            method: 'POST',
            body: formData
        })
            .then(response => {
    ...
    const handleEmpSigUpload = async () => {
        ...
        try {
            await axios.post('http://sun-api:8787/api/edoc/empSigUpload', formData, {
                headers: {
    ...
    useEffect(() => {
        ...
        const getDayOff = async (empCode) => {
            try {
                const response = await axios.get(`http://sun-api:8787/api/dayOff/${empCode}`);
