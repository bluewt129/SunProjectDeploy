...
const DocumentAppDetailComponent = () => {
            ...
            axios.get("http://sun-api:8787/api/edoc/getEDocAppList", { params: { edocCode } })
                .then((res) => {
                    ...
                    if (sessionEmpCode) {
                        ...
                        axios.get("http://sun-api:8787/api/edoc/getEmpSignatures?empCodes=" + filteredApprovers.map(approvers => approvers.empCode)).then((res) => {
    ...
    const handleSubmit = () => {
        ...
        axios.post("http://sun-api:8787/api/edoc/appSuccess", data)
    ...
    const handleRejectSubmit = () => {
        ...
        console.log(data);
        axios.post("http://sun-api:8787/api/edoc/appReject", data)
            .then(() => {
                closeModal();
