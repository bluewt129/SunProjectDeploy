...
const TimeTableListComponent = () => {
    ...
    useEffect(() => {
        axios.get("http://sun-api:8787/api/mrReservation/getReservationList")
            .then((res) => {
        ...
        axios.get("http://sun-api:8787/api/mrReservation/getMeetRoom")
            .then((res) => {
    ...
    function handleEventClick(info) {
        const { event } = info;
        axios.get(`http://sun-api:8787/api/mrReservation/getReservationDetail?mrrCode=${event.id}`)
            .then((res) => {
    ...
    const handleFormSubmit = (e) => {
        ...
        // 중복 검사
        axios.get("http://sun-api:8787/api/mrReservation/getReservationOverlap", {
            params: sendInsertData
        })
            .then((res) => {
                if (res.data === 0) {
                    axios.post("http://sun-api:8787/api/mrReservation/insertReservation", sendInsertData)
                        .then(() => {
                            setShowFormModal(false);
    ...
    const deleteReservation = (mrrCode) => {
        axios.delete(`http://sun-api:8787/api/mrReservation/deleteReservation/${mrrCode}`)
            .then((response) => {
